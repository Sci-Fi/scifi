...
echo "<option value=\"EC\">Economia</option> "
echo "<option value=\"VE\">Veterinaria</option> "
echo "<option value=\"FA\">Farmacia</option> "
echo "<option value=\"IA\">IACS</option> "
echo "<option value=\"EN\">Enfermagem</option> "
