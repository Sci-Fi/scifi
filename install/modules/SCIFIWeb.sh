...
# the installation will be finished ahead in e)
...
awk -v senha_keystore="$SSLCERTIFICATEPASSWD" -v senha="$senha_criptografada" '
	...
	/<security-domains>/{print;print "<security-domain name=\042Controller\042 cache-type=\042default\042>\012  <authentication>\012      <login-module code=\042org.jboss.security.auth.spi.UsersRolesLoginModule\042 flag=\042required\042>\012         <module-option name=\042usersProperties\042 value=\042${jboss.server.config.dir}/controller-users.properties\042/>\012          <module-option name=\042rolesProperties\042 value=\042${jboss.server.config.dir}/controller-roles.properties\042/>\012          <module-option name=\042hashAlgorithm\042 value=\042SHA-1\042/>\012     <module-option name=\042hashEncoding\042 value=\042base64\042/>\012     </login-module>\012   </authentication>\012</security-domain>";print "                <security-domain name=\042EncryptDBPassword\042>\012                   <authentication>\012                       <login-module code=\042org.picketbox.datasource.security.SecureIdentityLoginModule\042 flag=\042required\042>\012                            <module-option name=\042username\042 value=\042scifi\042/>\012                            <module-option name=\042password\042 value=\042"senha"\042/>\012                       </login-module>\012                   </authentication>\012                </security-domain>";next}1
...
# finishing postgresql jdbc installation
