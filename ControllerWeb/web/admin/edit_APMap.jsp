                            ...
                            <h:form id="EditForm" >
                                ...
                                <table> 
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:outputText value="#{JAPListMapBean.MAC}"></h:outputText></td>
                                        <h:inputHidden id="APIPhidden" value="#{JAPListMapBean.MAC}"/>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:outputText value="#{JAPListMapBean.IP}"></h:outputText></td>
                                        <h:inputHidden id="APMAChidden" value="#{JAPListMapBean.IP}"/>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="tdFormat"><h:outputText value="Localização:" /></td>
                                        <td class="tdInput"><h:inputText id="APLocation" value="#{JAPListMapBean.location}" validator="#{JAPInfoValidator.isEmpty}" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="tdFormat"><h:outputText value="Lista de Potências:" /></td>
                                        <td class="tdInput"><h:inputText id="APListTxPower" value="#{JAPListMapBean.listTxPower}" validator="#{JAPInfoValidator.checkListTxPower}" /></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APUnderloadThreshold" converterMessage="Valor inválido. Este campo deve conter um inteiro positivo." required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JAPListMapBean.underloadThreshold}" validator="#{JAPInfoValidator.isUnsignedInteger}" styleClass="newAPLine"/> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APOverloadThreshold" converterMessage="Valor inválido. Este campo deve conter um inteiro positivo." required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JAPListMapBean.overloadThreshold}" validator="#{JAPInfoValidator.checkOverloadThreshold}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APLatitude" converterMessage="Valor inválido" required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JAPListMapBean.latitude}" validator="#{JAPInfoValidator.checkLatitude}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APLongitude" converterMessage="Valor inválido" required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JAPListMapBean.longitude}" validator="#{JAPInfoValidator.checkLongitude}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="tdFormat"><h:outputText value="Região:" /></td>
                                        <td class="tdInput"><h:selectOneMenu id="APRegion" value="#{JAPListMapBean.region}" required="#{true}" requiredMessage="Uma região deve ser selecionada."><f:selectItems value="#{JAPListBean.regions}"/></h:selectOneMenu></td>
                                    </tr>
                                    <tr>
                                ...
                                <h:panelGrid columns="1" styleClass="tableFinal">
                                    ...
                                    <h:commandButton action="#{JAPListMapBean.updateList}" id="btt2" onclick="javascript: trocaCursor('url(../figuras/wait.gif)',this);" value="Salvar Modificações" styleClass="submit"></h:commandButton>
                                </h:panelGrid> 
