                            ...
                            <h:form id="newAPForm" >
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APUnderloadThreshold" converterMessage="Valor inválido. Este campo deve conter um inteiro positivo." required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JNewAPMapBean.underloadThreshold}" validator="#{JAPInfoValidator.isUnsignedInteger}" styleClass="newAPLine"/> </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APOverloadThreshold" converterMessage="Valor inválido. Este campo deve conter um inteiro positivo." required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JNewAPMapBean.overloadThreshold}" validator="#{JAPInfoValidator.checkOverloadThreshold}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APLatitude" converterMessage="Valor inválido" required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JNewAPMapBean.latitude}" validator="#{JAPInfoValidator.checkLatitude}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:inputText id="APLongitude" converterMessage="Valor inválido" required="#{true}" requiredMessage="Este valor deve ser preenchido." value="#{JNewAPMapBean.longitude}" validator="#{JAPInfoValidator.checkLongitude}" styleClass="newAPLine"/></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdInput"><h:selectOneMenu id="APRegion" value="#{JNewAPMapBean.region}" required="#{true}" requiredMessage="Uma região deve ser selecionada."><f:selectItems value="#{JAPListBean.regions}"/></h:selectOneMenu></td>
                                    </tr>
                                    <tr>
