...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Controlador Scifi - Excluir Região de Controle</title>
    ...
    <body>
        <div id="tudo">
            ...
            <div id="coluna_dir">
                <div id="titulo">Excluir Região de Controle<label id="info_unreachable"><label></label><a href="#" title="Controlador Scifi - Pontos de acesso incomunicantes" class="thickbox"></a><img src="../figuras/wait.gif"/></label> <a href="logout.jsf" id="logout">Logout</a> </div>
